...
if(null != eform_data){
	...
	//ExportInfo exportInfo = ClipEFormExport.createExportForTIF(request, eform_data, isbase64Encoding, tifOption);
		
	ExportInfo exportInfo = ClipEFormExport.createExportForTIF(request, eform_data, isbase64Encoding, tifOption, propertyPath);
