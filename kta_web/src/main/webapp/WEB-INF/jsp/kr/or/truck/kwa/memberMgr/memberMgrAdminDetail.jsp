								...
								<span class="title">${result.HANGEUL_NM}</span>
									...
									<div class="box-content">
										<div class="row box-section">
											...
											<div class="col-md-9">
												 <input type="text" placeholder="사원번호" value="${result.SAWON_NO}" class="form-control" disabled="true">
											</div>
										</div>
										<div class="row box-section">
											<div class="col-md-3" >이름</div>
											<div class="col-md-9">
												 <input type="text" placeholder="NAME" value="${result.HANGEUL_NM}" class="form-control" disabled="true" >
											</div>
										</div>
										<div class="row box-section">
											<div class="col-md-3" >직위</div>
											<div class="col-md-9">
												 <input type="text" placeholder="직위" value="${result.JICWI_CD}" class="form-control" disabled="true" >
											</div>
										</div>
										<div class="row box-section">
											<div class="col-md-3" >지부</div>
											<div class="col-md-9">
												 <input type="text" placeholder="지부" value="${result.JIBU_NAME}" class="form-control" disabled="true" >
											</div>
										</div>
										<div class="row box-section">
											<div class="col-md-3" >주소</div>
											<div class="col-md-9">
												 <input type="text" placeholder="주소" value="${result.SILGEOJU_POST_NO}   ${result.SILGEOJU_JUSO}" class="form-control" disabled="true">
											</div>
										</div>
										<div class="row box-section">
											<div class="col-md-3" >지부</div>
										...
										<div class="row box-section">
											...
											<div class="col-md-9">
												 <input type="text" placeholder="CELL" value="${result.SILGEOJU_TEL_NO}" class="form-control" disabled="true" >
											</div>
										</div>
										<div class="row box-section">
											<div class="col-md-3" >전화번호</div>
											<div class="col-md-9">
												 <input type="text" placeholder="PHONE" value="${result.HP_NO}" class="form-control" disabled="true">
											</div>
										</div>
									</div>
								</form>
