...
$(document).ready(function(){
	...
	/* if('${searchVO.searchRecentDate}' == ''){
		$("form#f input[id='month3']").attr("checked",true);
...
function printDocument(){
	...
	document.f.action = "<c:url value='/netCounter/certService/printJoinFactCar.do'/>";
...
function searchJoinFactCert(){
	document.f.pageIndex.value = "0";
	document.f.action = "<c:url value='/netCounter/certService/searchJoinFactIndex.do'/>";
   	document.f.submit();
}
			...
			<div class="contents" id="Contents">
				<div class="conTitle">
					...
					<div class="location">
						...
						<span>공제가입사실증명서 통합공제</span>
					</div>
				</div><!--// conTitle e -->
				<div class="conaArea">
					<div class="conSection clfix">
						<p class="confirTit"><img src="/images/truck/net/service_tit01.gif" alt="통합공제 가입사실증명서 발급 서비스 입니다 용도 및 기타 내용을 작성하고 차량을 선택하여 발급하기 버튼을 클릭해 주시기 바랍니다" /></p>
							...
							<div class="searchUp">
								<div class="option">
									<dl>
										...
										<dd>
											<div class="btn_srch">
												<span class="btn_pack btn_type04" style="vertical-align:middle !important;"><a href="#;" onclick="searchJoinFactCert(); return false;" class="bold">검색하기</a></span>
											</div>
										</dd>
									</dl>
								</div>
						...
						<div class="bbsList1">
							<table class="tbWork_st01" summary="공제가입사실증명서 통합공제">
