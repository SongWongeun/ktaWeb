...
<div class="main-content">
	...
	<div class="container" style="max-width: none;width:1460px;">
				...
				data : {
					data : [
                            ...
                            %>
                            				...
                            				{"x":<%="'"+l+"월'"%>,"y1":<%=y1%>,"y2":<%=y2%>,"y3":<%=y3%>,"y4":<%=y4%>,"y5":<%=y5%>,"y6":<%=y6%>,"y7":<%=y7%>,"y8":<%=y8%>}
                            <%	
                            		}
                            %>
			...
			<div class="box">
				...
				<div class="box-content"> 
							...
							<table class="table table-normal">
								<colgroup>
									<col style="10%"/>
									<col style="width:7.5%"/><col style="width:7.5%"/><col style="width:7.5%"/><col style="width:7.5%"/><col style="width:7.5%"/>
									<col style="width:7.5%"/><col style="width:7.5%"/><col style="width:7.5%"/><col style="width:7.5%"/><col style="width:7.5%"/>
								...
								<thead>
									<tr class="status-pending">
										<td>2depth</td>
										<td>01월</td><td>02월</td><td>03월</td><td>04월</td><td>05월</td><td>06월</td><td>07월</td><td>08월</td><td>09월</td><td>10월</td>
										<td>11월</td><td>12월</td>
									</tr>
								</thead>
							 	<tbody>
