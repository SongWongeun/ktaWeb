		...
		<article class="tabWrap">
			...
			<div class="tabBox">
				<ul >
					...
					<li class="on"><a href="/m/infoLounge/scholarship/result/view.do">장학금지원내역</a></li>
				</ul>
			</div>
			<!-- 본인인증 -->
			<div class="userLogin">
				<h2>장학금 지원내역 확인</h2>
				<p class="txtSt01">장학금을 신청하셨나요? 본인 인증 후,<br/>장학금 지원 내역을 확인 하실 수 있습니다.</p>
				<p class="authBox"><a id="alinkHp" href="#;">휴대폰 인증</a></p>
				<p class="txtSt02">실명확인절차 입니다.<br/>다소 번거로우시더라도 양해 부탁 드립니다.</p>
			</div>
		</article><!--// tabWrap -->
		<%-- hp 인증 팝업에서 사용 --%>
