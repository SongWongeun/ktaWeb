			...
			<div class="box">
				...
				<div class="box-header">
					<ul class="nav nav-tabs nav-tabs-left">
						...
						<li class=""><a href="#sts_category" data-toggle="tab" id="label_category">카테고리별 통계</a></li>
						<li class="active"><a href="#sts_category" data-toggle="tab" id="label_category">담당자별 통계</a></li>
...
<div class="container" style="max-width: none;width:1300px;padding:0px;">
		<div class="col-md-12 padded"> 
			<div class="box">
				...
				<div class="box-content padded">
					<div class="sine-chart" style="height: 400px" id="xchart-statistics"></div>
				</div>
		...
		<script>
			...
			var options = {
				    ...
				    func: {
				        tip: function(tipElement, data, rect) {
				            var date = data.xaxis;
				            var tip = '<div class="text">'+ String(data.yaxis).format()+'건 </div>';
			...
			var chart = webponent.chart.init($("#xchart-statistics"), options, styles, series);
		</script>
