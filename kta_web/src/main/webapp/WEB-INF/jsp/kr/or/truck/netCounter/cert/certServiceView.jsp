...
function fnOpen()
{
	...
	// 옵션 - 레포트 파라메터
	//oReport.param("vhr_req_seq_no").value = "104";
	//oReport.param("year").value = "1988";
	...
	*/
	...
	oReport.dataset("XMLDS4").xpath = "gubun/rpt4/rexdataset/rexrow";
	oReport.dataset("XMLDS5").xpath = "gubun/rpt5/rexdataset/rexrow";
	oReport.dataset("XMLDS6").xpath = "gubun/rpt6/rexdataset/rexrow";
	oReport.dataset("XMLDS7").xpath = "gubun/rpt7/rexdataset/rexrow";
	oReport.data = sData;
	...
	oReport.data = sData;		
		...
		oReport.type = "memo";
		oReport.datatype = "xml";
		oReport.dataset("XMLDS1").xpath = "gubun/rpt/rexdataset/main/rexrow";
		oReport.dataset("XMLDS2").xpath = "gubun/rpt/rexdataset/rexrow";
		oReport.data = sData;			
	}
	//-----------------------------------------
	...
	*/
	...
	//oReport.event.rexperterror = fnReportEvent;
