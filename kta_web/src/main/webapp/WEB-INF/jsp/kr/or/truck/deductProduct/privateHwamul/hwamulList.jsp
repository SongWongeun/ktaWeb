...
function viewArticle(no) {
	document.boardForm.articleNo.value = no;
   	document.boardForm.action = "<c:url value='/deductProduct/privateHwamul/hwamulListDetail.do'/>";
   	document.boardForm.submit();		
}
/* 글 등록 화면 function */
	...
	<div id="wrap">
		...
		<div id="container">
			<div class="contents" id="Contents">
				<div class="conTitle">
					<div class="title">
						<h2><img src="/images/truck/cust/guide_sub_tit.gif" alt="상담신청 결과확인" /></h2>
					...
					<div class="conSection">
						<p class="infosearchWrap">
							<form:select path="searchCondition" title="1:1문의검색옵션" name="" >
								...
								<form:option selected="selected" value="1">제목</form:option>
