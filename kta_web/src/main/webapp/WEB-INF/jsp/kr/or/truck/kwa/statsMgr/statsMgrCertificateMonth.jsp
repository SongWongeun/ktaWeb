						...
						data : [
							<%		         
								for(int l=1;l<=12;l++){
									...
									Object y = rMapBun.get(tYM)==null?0+"":rMapBun.get(tYM).get("CNT");
									if( l>1 ) {
							%> 	
							        			,
							<%			
						...
						data : [
							<%		         
								for(int l=1;l<=12;l++){
									String tM = l < 10 ? "0"+l : l+"";
									String tYM = reqYear + tM;
									Object y = rMapGongJoin.get(tYM)==null?0+"":rMapGongJoin.get(tYM).get("CNT");
									if( l>1 ) {
	                       	%> 	
		                                			,
		                    <%			
						...
						data : [
							<%		         
								for(int l=1;l<=12;l++){
									String tM = l < 10 ? "0"+l : l+"";
									String tYM = reqYear + tM;
									Object y = rMapGongCareer.get(tYM)==null?0+"":rMapGongCareer.get(tYM).get("CNT");
									if( l>1 ) {
	                       	%> 	
		                                			,
		                    <%			
						...
						data : [
							<%		         
								for(int l=1;l<=12;l++){
									String tM = l < 10 ? "0"+l : l+"";
									String tYM = reqYear + tM;
									Object y = rMapMul.get(tYM)==null?0+"":rMapMul.get(tYM).get("CNT");
									if( l>1 ) {
	                       	%> 	
		                                			,
		                    <%			
