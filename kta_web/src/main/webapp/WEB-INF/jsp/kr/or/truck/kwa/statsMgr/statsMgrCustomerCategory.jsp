			...
			<div class="box">
				...
				<div class="box-header">
					<ul class="nav nav-tabs nav-tabs-left">
						...
						<li class="active"><a href="#sts_category" data-toggle="tab" id="label_category">카테고리별 통계</a></li>
						<li class=""><a href="#sts_manager" data-toggle="tab" id="label_manager">담당자별 통계</a></li>
