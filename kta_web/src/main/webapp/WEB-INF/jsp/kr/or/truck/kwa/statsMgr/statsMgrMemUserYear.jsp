					...
					data : {
						data : [
                        		...
                        		for(int l=startYear;l<=cY;l++){
                        			Object rMapM = rMapMem.get(l+"")==null?0+"":rMapMem.get(l+"").get("CNT");
                        			Object rMapNoM = rMapNoMem.get(l+"")==null?0+"":rMapNoMem.get(l+"").get("CNT");
	                        ...
	                        %>
	                        		...
	                        		{month:<%="'"+l+"년'"%>, rMapM:<%=rMapM%>,rMapNoM:<%=rMapNoM%>,rMapHuM:<%=rMapHuM%>}
	                        <%	
                        		}
	                        %>
				               ]	
