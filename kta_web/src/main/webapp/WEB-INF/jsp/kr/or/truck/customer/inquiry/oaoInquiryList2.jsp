...
/* 글 목록 화면 function */
function listBoard() {
	document.boardForm.action = "<c:url value='/customer/inquiry/oaoInquiryList2.do'/>";
   	document.boardForm.submit();
}
/* 글 보기 화면 function */
function viewArticle(no) {
	document.boardForm.articleNo.value = no;
   	document.boardForm.action = "<c:url value='/customer/inquiry/oaoResultIndex2.do'/>";
   	document.boardForm.submit();		
}
/* 글 등록 화면 function */
function viewRegistBoard() {
   	document.boardForm.action = "<c:url value='/customer/inquiry/viewRegistBoard.do'/>";
   	document.boardForm.submit();		
} 
	...
	<div id="wrap">
		...
		<div id="container">
			<div class="contents" id="Contents">
				<div class="conTitle">
					<div class="title">
						<h2><img src="/images/truck/cust/list_tit.gif" alt="민원리스트" /></h2>
				...
				<div class="conaArea">
					<p class="confirTit"><img src="/images/truck/cust/list_con_tit.gif" alt="화물공제조합에 접수 및 처리된 전자 민원 리스트 입니다. 유사한 민원 사례의 검색을 통해 보다 빠른 처리가 가능합니다." /></p>
					...
					<div class="conSection">
						<p class="infosearchWrap">
							<form:select path="searchCondition" title="1:1문의검색옵션" name="" >
						...
						<!-- table list s -->
						<div class="bbsList1">
							<table class="tbList_st01" summary="1:1문의 게시판 목록입니다. 번호,제목,작성일">
								<caption>1:1문의 게시판 목록입니다.</caption>
								<colgroup>
									<col width="9%">
									<col width="79%">
									<col width="12%">
