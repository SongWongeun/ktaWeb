...
<c:set var="registerFlag" value="${empty driverBoardVO.articleNo ? '등록' : '수정'}"/>
...
/* 글 등록 function */
function saveDriverBoard(html,text) {
    ...
    f.action = "<c:url value="${registerFlag == '등록' ? '/kwa/cyberPr/driversDayAdd.do' : '/kwa/cyberPr/driversDayModify.do'}"/>";
    f.submit();  
}

/* 글 삭제 funciton*/
function deleteDriverBoard() {
   	document.boardForm.action = "<c:url value='/kwa/cyberPr/driversDayDelete.do'/>";
   	document.boardForm.submit();		
}
...
<div class="main-content">
	<form:form commandName="driverBoardVO" name="boardForm" enctype="multipart/form-data">
		<form:hidden path="articleNo"/><br>
		<form:hidden path="atchFileId"/><br>
		<input type="hidden" id="bmstNo" name="bmstNo" value="10"/>
	...
	<div class="container">
							...
							<form class="fill-up">
								...
								<div class="box-content">
									<div class="row box-section">
										...
										<div class="col-md-9">
											<input type="text" value="${resultMap.CATEGORY}" alt="카테고리" placeholder="CATEGORY" class="form-control">
										</div>
									</div>
									<div class="row box-section">
										<div class="col-md-3" >카테고리</div>
									...
									<div class="row box-section">
										...
										<div class="col-md-9">
										<code id="contentHtml" style="display:none;">${driverBoardVO.contentHtml}</code>
									...
									<div class="row box-section">
										...
										<div class="col-md-9">
											<c:if test="${not empty driverBoardVO.atchFileId}">
												<c:import url="/com/atch/selectFileInfsForUpdate.do" charEncoding="utf-8">
												<c:param name="param_atchFileId" value="${driverBoardVO.atchFileId}" />
												</c:import>
								 			</c:if> 
								 			<c:if test="${empty driverBoardVO.atchFileId}">
			...
			<ul class="padded separate-sections">
				<li align="right">
					<a href="#;" onclick="saveDriverBoard(CrossEditor.GetBodyValue(),CrossEditor.GetTextValue())"  class="btn btn-blue">
