...
<link rel="stylesheet" type="text/css" href="/css/m_truck/m_main_v2.css" />
</head>
<body>
<div id="wrap" class="wrapMain_v02">
	<!-- header -->
	<header id="header_v02">
	...
	<nav id="navMain_v02">
					...
					<c:when test="${noticeIcon!=null||!noticeIcon eq ''}">
						<c:choose>
							<c:when test="${noticeIcon.URL!=null||!noticeIcon.URL eq ''}">
								<a href="${noticeIcon.URL}" style="background: url('/images/m_truck/main/theme02/${noticeIcon.CODE}${noticeIcon.YEAR}.png');">공지사항</a>
							</c:when>
							<c:otherwise>
								<a href="/m/infoLounge/deductNews/list.do" style="background: url('/images/m_truck/main/theme02/${noticeIcon.CODE}${noticeIcon.YEAR}.png');">공지사항</a>	
							</c:otherwise>
						</c:choose>
					</c:when>
					<c:otherwise>
		...
		<ul>
			...
			<li><a href="https://card.truck.or.kr" target="_self">카드수납시스템</a></li>
		</ul>
	</nav>
	<!--// nav -->
	<!-- main banner -->
	<div id="bannerMain_v02" style ="margin-bottom:5px"><a href="tel:1577-8278"><img src="/images/m_truck/main/tel_w1@2x.png" alt="현장출동서비스 1577-8278" /></a></div>
	<div id="bannerMain_v02"><a href="tel:1577-8305"><img src="/images/m_truck/main/tel_w1@3x.png" alt="민원콜센터 1577-8305" /></a></div>
	<div id="bannerMain_v02" style ="margin-top:5px">
		<a href="/m/deductProduct/privateHwamul/mHwamulInfo.do"><img src="/images/m_truck/main/hwamul_w1@3x.png" alt="개인화물 가입안내"/></a>
		
	</div>
	<!--// main banner -->
	<!-- footer -->
	<footer id="footer_v02">
		<div>			<ul>
