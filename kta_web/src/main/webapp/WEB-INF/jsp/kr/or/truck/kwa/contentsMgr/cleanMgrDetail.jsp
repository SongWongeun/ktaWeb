...
function backtoIndex(){
	document.boardForm.action = "<c:url value='/kwa/contentMgr/cleanCenterList.do'/>";
...
<!--// left e -->
	...
	<div class="main-content">
		...
		<ul class="padded separate-sections">
			<li align="right">
			  <!-- <a id="basicmodify" class="btn btn-blue" href="javascript:contentsModify();">수정하기</a>
			  <a id="basicmodify" class="btn btn-blue" href="javascript:contentsDelete();">삭제하기</a> -->
