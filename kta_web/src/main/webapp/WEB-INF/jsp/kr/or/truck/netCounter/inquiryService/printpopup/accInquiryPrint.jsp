		...
		<!-- 가입중인차량현황 s -->
			<p class="etcTxt">&#40;기준일자 &#58; <fmt:formatDate value="<%=new Date() %>" pattern="yyyy년 MM월 dd일" /> &#41;</p>
								<table class="tbWork_st01" summary="가입중인 차량현황 상세정보 테이블 입니다." style="margin-top: 20px;">
										<thead>
											<tr>
											<th scope="col" style='width: 11%;'>조합원명</th>
											<th scope="col" style='width: 9%;'>차량번호</th>
											<th scope="col" style='width: 10%;'>계약번호</th>
											<th scope="col" style='width: 7%;'>계약상태</th>
											<th scope="col" style='width: 6%;'>상품종류</th>
											<th scope="col" style='width: 5%;'>이름</th>
											<th scope="col" style='width: 10%;'>계약기간</th>
											<th scope="col" style='width: 8%;'>분담금총액</th>
											<th scope="col" style='width: 8%;'>수납금액</th>
											<th scope="col" style='width: 6%;'>분납회차</th>
											<th scope="col" style='width: 9%;'>차회납입일</th>
											<th scope="col" style='width: 7%;'>차회분담금</th>
											<th scope="col" style='width: 7%;'>보상건수</th>
										</tr>
										</thead>
										<tbody id="tbody_need">
										<c:if test="${carStatusInquiryList!=null}">
											<c:forEach var="carInquiry" items="${carStatusInquiryList}" varStatus="s">
												<tr>
													...
													<td>${carInquiry.JAEHAE_CD}</td>
													<td>${carInquiry.JONGSA_NM}</td>
