...
function addPraiseBoard() {
   	document.boardForm.action = "<c:url value='/customer/praise/praiseAddView.do'/>";
   	document.boardForm.submit();		
}
/* index function */
function listPraiseBoard() {
	document.location.href = "/customer/praise/praiseListIndex.do";
}
/* 글 검색 function */
...
$(document).ready(function(){
	...
	alert('글'+param+' 완료되었습니다. 관리자 확인 후 등록됩니다.');
});
</script>
</c:if>
</head>
	...
	<div id="wrap">
		...
		<div id="container">
			<div class="contents" id="Contents">
				...
				<div class="conaArea">
					<p class="confirTit"><img src="/images/truck/cust/praise_con_tit.gif" alt="화물공제조합의 서비스에 만족하셨나요 더욱 나은 서비스를 위해 고객의 칭찬에 힘을 얻는 화물공제조합을 칭찬해 주세요" /></p>
					...
					<div class="conSection">
						<div class="praiseArea">
							<p>고객님 여러분들께서 해 주시는 쓴소리는 채찍질로 단소리는 에너지로 소중히 간직하겠습니다&#46;</p>
							<a href="/customer/praise/praiseAddView.do" class="btn_praise"><img src="/images/truck/cust/btn_praise.gif" alt="칭찬글등록" /></a>
						</div>
						<!-- 검색 -->
						<p class="infosearchWrap">
							...
							<label class="hide" for="search">검색어입력</label><form:input path="searchKeyword" id="search" title="검색어를 입력해주세요" style="width:173px" class="txt" svalue=""/>
							<a class="btn_search" href="#;" onclick="searchPraiseBoard(); return false;"><img class="vaM" src="/images/truck/btn/btn_search.gif" alt="검색" /></a>
						</p>
						<!-- table list s -->
						<div class="bbsList1">
								...
								<c:if test="${not empty resultList}">
									...
									${fn:replace(result.createTime, '.', '')}
									 ...
									 <tr>
									    ...
									    <td class="alL ellipsis"><a href="#;" onclick="viewPraiseBoard('<c:out value="${result.articleNo}"/>')">${fn:replace(result.title, keyword , highlight )}</a>
									    <%
							...
							<!-- paging s -->							
							<div class="paging">
								<ui:pagination paginationInfo = "${paginationInfo}" type="image" jsFunction="pagingPraiseBoard" />
