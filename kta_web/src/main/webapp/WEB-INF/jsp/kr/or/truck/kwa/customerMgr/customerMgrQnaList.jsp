...
function searchPaging(pageNo){
	...
	document.listForm.action = "<c:url value='/kwa/customerMgr/qna/list.do'/>";
   	document.listForm.submit();
}
function contentsDetail(articleNo){
	document.listForm.articleNo.value = articleNo;
	document.listForm.action = "<c:url value='/kwa/customerMgr/qna/detail.do'/>";
   	document.listForm.submit();
}
function searchList(){
				...
				<div class="box">
					...
					<div class="box-content padded">
						...
						<select id="searchCondition3" name="searchCondition3" class="btn btn-default btn-sm">
							<li class=""><span class="title"><option value="0" label="전체" <c:if test="${searchVO.searchCondition3==0}">selected="selected"</c:if>/></span></li>
							<li class=""><span class="title"><option value="1" label="제목" <c:if test="${searchVO.searchCondition3==1}">selected="selected"</c:if>/></span></li>
