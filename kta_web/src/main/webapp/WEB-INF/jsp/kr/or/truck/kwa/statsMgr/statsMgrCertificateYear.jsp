			...
			<div class="box">
				...
				<div class="box-header">
					<ul class="nav nav-tabs nav-tabs-left">
						<li class="active"><a href="#sts_year" data-toggle="tab" id="label_sts_year">년별 통계</a></li>
...
<div class="container" style="max-width: none;width:1300px;padding:0px;">
		<div class="col-md-6 padded"> <!-- col-md-12 : 하나씩 / col-md-6 : 두개씩 -->
			<div class="box">
				<div class="box-header">
					...
					data : {
						data : [
                        		...
                        		for(int l=startYear;l<=cY;l++){
                        			Object y = rMapBun.get(l+"")==null?0+"":rMapBun.get(l+"").get("CNT");
                        			if( l>startYear ) {
	                       	%> 	
		                                			,
		                    <%			
			...
			var options2 = {
					data : {
						data : [
								<%		         
                        		for(int l=startYear;l<=cY;l++){
                        			Object y = rMapGongJoin.get(l+"")==null?0+"":rMapGongJoin.get(l+"").get("CNT");
                        			if( l>startYear ) {
	                       	%> 	
		                                			,
		                    <%			
			...
			var options3 = {
					data : {
						data : [
								<%		         
                        		for(int l=startYear;l<=cY;l++){
                        			Object y = rMapGongCareer.get(l+"")==null?0+"":rMapGongCareer.get(l+"").get("CNT");
                        			if( l>startYear ) {
	                       	%> 	
		                                			,
		                    <%			
			...
			var options4 = {
					data : {
						data : [
								<%		         
                        		for(int l=startYear;l<=cY;l++){
                        			Object y = rMapMul.get(l+"")==null?0+"":rMapMul.get(l+"").get("CNT");
                        			if( l>startYear ) {
	                       	%> 	
		                                			,
		                    <%			
