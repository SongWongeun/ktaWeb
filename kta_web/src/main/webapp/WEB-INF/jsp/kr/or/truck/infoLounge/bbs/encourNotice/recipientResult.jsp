...
<%
	...
	*********************************** */
    ...
    String sReturnUrlHp = "http://"+request.getServerName()+"/checkplus_success.do";      // 성공시 이동될 URL
    String sErrorUrlHp = "http://"+request.getServerName()+"/checkplus_fail.do";          // 실패시 이동될 URL
    //String sReturnUrlHp = "http://localhost:8080/checkplus_success.do";      // 성공시 이동될 URL
    //String sErrorUrlHp = "http://localhost:8080/checkplus_fail.do";          // 실패시 이동될 URL
...
<%
	...
	*********************************************************************************************************************************************/
	...
	└────────────────────────────────────────────────────────────────────
	*/
	String sReturnURLIpin				= "http://"+request.getServerName()+"/ipin_process.do";
...
*********************************** */
    ...
    String sReturnURL 		= "http://"+request.getServerName()+"/niceID_return.do";	//결과 수신 URL    
						...
						<div class="supportCont">
							...
							<div class="roundBox">
								...
								<div class="supportArea">
									<p class="supTxt"><img src="/images/truck/info/reci_txt01.gif" alt="장학금 지원내역 확인" /></p>
									<p class="txt03 mB30">2014년 상반기 장학금 지원내역을 본인 인증 후 확인 할 수 있습니다&#46;</p>
