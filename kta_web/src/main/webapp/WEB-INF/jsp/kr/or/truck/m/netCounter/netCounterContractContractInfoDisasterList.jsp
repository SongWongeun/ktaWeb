		...
		<article class="tabWrap">
			...
			<div class="basicCont02">
				...
				<div class="list">
					...
					<div class="listDiv">
						<table class="tbList">
							...
							<tr>
								...
								<th>차종</th>
								<td class="textRight borrNone">${resultList[0].car_kind_nm}</td>
							</tr>
							<tr>
								<th>차명</th>
								<td>${resultList[0].car_nm}</td>
								<th>차대번호</th>
								<td class="textRight borrNone">${resultList[0].car_body_no}</td>
							</tr>
							<tr>
								<th>년식</th>
								<td>${resultList[0].car_yy}년</td>
								<th>적재정량</th>
								<td class="textRight borrNone">${resultList[0].proper_wg} kg</td>
							</tr>
							<tr>
								<th class="borbNone">총 중 량</th>
								<td class="borbNone" colspan="3">${resultList[0].tot_wg} kg</td>
							</tr>
						</table>
					</div>
					<!-- 종사자정보 -->
					<h3 class="listTit"><span>종사자정보</span></h3>
					<div class="listDiv">
						<table class="tbList">
							<colgroup>
								<col width="35%">
							...
							<tr>
								<th>종사자</th>
								<td class="borrNone">${resultList[0].jongsa_nm}</td>
							</tr>
							<tr>
								<th>주민번호</th>
								<td class="borrNone">${resultList[0].jongsa_jumin_no}</td>
							</tr>
							<tr>
								<th class="borbNone">연락처</th>
								<td class="borrNone borbNone">${resultList[0].tel_local_no} - ${resultList[0].tel_no}</td>
							</tr>
						</table>
					</div>
					<!-- 계약기간(계약상태) -->
					...
					<div class="listDiv">
						<p class="txt01"><span>- 법률비용지원 특별약관</span></p>
					</div>
					<!-- 청약사항 -->
					<h3 class="listTit"><span>청약사항</span></h3>
					<div class="listDiv">
						<table class="tbList">
							<colgroup>
								<col width="35%">
