...
$(document).ready(function(){
	...
	$('a#findSubmit').on('click',function(e){
		...
		document.f.agent_cd.value = agentCd;
		document.f.action="/login/alterPwd.do";
		document.f.submit();
	});
...
function typeSelecter(){
	...
	$.ajax({
		url: '/login/findInfoPw/checkInfo.do',
		dataType: "html",
		data : {
	       	 "jumin1" : jumin1
           , "jumin2" : jumin2
...
$(document).ready(function(){
	...
	}else if(param =='incorrectAccess'){
		alert('잘못된 접근입니다.');
	}else if(param =='nullAccess'){
		alert('실명인증 후 이용해주세요');
	}
});
</script>
	...
	<div id="wrap">
		...
		<div id="container">
			<div class="contents" id="Contents">
				<div class="conTitle">
					<div class="title">
 						<h2 style="font-size: 38px;font-weight: bolder;color: #143B8F;">비밀번호 찾기</h2>
					</div>
					<div class="location">
						<a class="ico_home" href="#;" onclick="goIndex(); return false;">HOME</a>
						<a href="/login/findInfoPw.do" >아이디  &#183; 비밀번호찾기</a>
					</div>
				</div><!--// conTitle e -->
				<div class="conaArea">
					<!-- <p class="confirTit">
					...
					<div class="conSection">
						...
						<input type="hidden" name="agent_cd" id="agent_cd"/>
						<input type="hidden" name="saupnum" id="saupnum"/>
						<fieldset>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<input name="id" class="txt" id="id" type="text" style="width:150px" value=""/>
									</td>
								</tr>
								<tr>
		...
		<div id="typePopupLayer" style="display:none;">
			<div class="layerBox">
				<div class="layerContents">
					...
					<p class="layerTit" style="text-align:center;"> 비밀번호찾기</p>
					<p style="text-align:center;"><span>새로운 비밀번호를 입력해주세요.</span></p>
					<div class="layerA">
							...
							<div class="btnboxC clfix">
								<span class="btn_pack btn_type16"><a id="findSubmit" href="#;">비밀번호 변경</a></span>
							</div>
						</div>
					</div>
				</div>
