...
/* 글 수정 화면 function */
function updateDeductBoard(no) {
	document.boardForm.articleNo.value=no;
   	document.boardForm.action = "<c:url value='/kwa/infoLounge/deductNewsUpdate.do'/>";
					...
					<div class="conSection">
						...
						<div class="bbsView1">
							<table class="tbView_st01" summary="제목,작성일,본문내용을 순서로 나타낸 게시물 입니다.">
								...
								<tbody>
									<%-- <tr>									
										<td align="right"><c:if test="${not empty resultBoard.atchFileId}">
							...
							<div class="btnboxR clfix">
								<span class="btn_pack btn_type01 icon"><span class="check"></span><a href="#;" onclick="listDeductBoard();">목록</a></span>
							</div>
						</div>
						</fieldset>
						</form:form>
