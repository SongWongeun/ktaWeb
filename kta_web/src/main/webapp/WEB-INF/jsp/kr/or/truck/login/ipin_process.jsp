...
<%
	...
	**********************************************************************************************/
	...
	String strAction = "/actIpinLogin.do?t="+t;
	// 회원로그인일 경우 agentCd( 1:조합원, 2:차량관리자, 3:거래처) 이며
	// 본인인증일 경우 'authenticate' 임
	if( "authenticate".equals(sReservedParam1) ){ 
...
<head>
	...
	<script language='javascript'>
		function fnLoad()
		{
			...
			parent.opener.parent.document.vnoform.param_r1.value = "<%= sReservedParam1 %>";<%-- agentCd --%>
			...
			parent.opener.parent.document.vnoform.action = "<%=strAction%>";
