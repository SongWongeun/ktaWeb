...
$(document).ready(function(){
	...
	if('${accordJumin}'=='NO'){
		alert("대표자 정보와 추가하려는 사업자 정보가 일치하지 않습 니다.");
	}
...
function fnSubmit()
{
	...
	document.form1.action = "/nc_totalContractInquiry.do";
	if(confirm("입력한 정보로 변경하시겠습니까?")){
	...
	<div id="wrap">
		...
		<div id="container">
			<div class="contents" id="Contents">
				...
				<div class="conTitle">
					<div class="title">
 						<h2><img src="/images/truck/net/join_tit04.gif" alt="" /></h2>
				...
				<div class="conaArea">
					<p class="confirTit"><img src="/images/truck/net/union_con_tit04.gif" alt="회원가입된 사업자 이외에 사업자를 추가로 등록하실 수 있습니다." /></p>
					...
					<div class="certifyArea">
						...
						<div class="roundBox certifyBox">
							...
							<input type="hidden" name="agent_no" value="${searchVO.agent_no }"/>
							<input type="hidden" name="saupjang_seq" value="${searchVO.saupjang_seq }"/>
							<input type="hidden" name="car_gaip_no" value="${searchVO.car_gaip_no }"/>
							<input type="hidden" name="gyeyak_no" value="${searchVO.gyeyak_no }"/>
							<input type="hidden" name="saupja_no" value="${searchVO.saupja_no }"/>
 							<input type="hidden" name="gyeyak_jibu_cd" value="${searchVO.gyeyak_jibu_cd }"/>
							</form>
