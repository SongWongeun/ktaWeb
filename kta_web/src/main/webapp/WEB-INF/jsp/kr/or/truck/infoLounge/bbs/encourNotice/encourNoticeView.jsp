...
<meta property="og:title" content="화물공제조합 - 장학사업 공지"/>
...
/* 글 수정 화면 function */
function updateEncourBoard(no) {
	document.boardForm.articleNo.value=no;
   	document.boardForm.action = "<c:url value='/infoLounge/encourNoticeUpdate.do'/>";
...
/* 글 삭제 화면 function */
function deleteEncourBoard(no) {
	document.boardForm.articleNo.value = no;
   	document.boardForm.action = "<c:url value='/infoLounge/encourNoticeDelete.do'/>";
   	document.boardForm.submit();		
}
					...
					<div class="conSection">
						...
						<div class="bbsView1">
							...
							<div class="btnboxR clfix">
								<span class="btn_pack btn_type01 icon"><span class="check"></span><a href="#;" onclick="listEncourBoard()">목록</a></span>
							</div>
						</div>
						</fieldset>
						</form:form>
...
<%-- <form:form commandName="encourNoticeBoardVO" name="boardForm" method="post">
...
<br>
<br>
<a href="javascript:listEncourBoard()">목록으로</a><br>
<a href="javascript:updateEncourBoard('<c:out value="${resultBoard.articleNo}"/>')">수정하기</a><br>
<a href="javascript:deleteEncourBoard('<c:out value="${resultBoard.articleNo}"/>')">삭제하기</a><br>
