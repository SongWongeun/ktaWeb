	...
	<div id="wrap">
		...
		<div id="container">
			<div class="contents" id="Contents">
				<div class="conTitle">
					<div class="title">
 						<h2><img src="/images/truck/cust/fraud_result_tit.gif" alt="제보결과확인" /></h2>
				...
				<div class="conaArea">
					...
					<p class="confirTit"><img src="/images/truck/cust/fraud_result_con_tit.gif" alt="고객님의 문의내용에 대한 문의 결과 입니다 추가 문의가 필요하신 분께서는 1:1문의로 재 문의해 주세요" /></p>
