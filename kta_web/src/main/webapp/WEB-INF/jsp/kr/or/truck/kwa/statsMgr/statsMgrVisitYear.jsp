			...
			<div class="box">
				...
				<div class="box-header">
					<ul class="nav nav-tabs nav-tabs-left">
						...
						<li class=""><a href="#sts_visCon" data-toggle="tab" id="label_visCon">사용자 환경</a></li>
					</ul>
				</div>
...
<div class="container" style="max-width: none;width:1300px;padding:0px;">
		<div class="col-md-6 padded"> <!-- col-md-12 : 하나씩 / col-md-6 : 두개씩 -->
			<div class="box">
				...
				<div class="box-content padded">
					<div class="sine-chart" style="height: 300px" id="xchart-statistics"></div>
				</div>
		...
		<script>
			<%
				// 
				Map<String, Map<String, Object>> totalCount = (Map<String, Map<String, Object>>)request.getAttribute("totalCount");
			%>
			...
			var options = {
					data : {
						data : [
                        		...
                        		for(int l=startYear;l<=cY;l++){
                        			Object total = totalCount.get(l+"")==null?0+"":totalCount.get(l+"").get("CNT");
                        			if( l>startYear ) {
	                       	%> 	
		                                			,
		                    <%			
				    ...
				    func: {
				        tip: function(tipElement, data, rect) {
				            var date = data.xaxis;
				            var tip = '<div class="text">' + date + ': ' + String(data.yaxis).format()+'명 </div>';
			...
			var chart1 = webponent.chart.init($("#xchart-statistics"), options, styles, series);
