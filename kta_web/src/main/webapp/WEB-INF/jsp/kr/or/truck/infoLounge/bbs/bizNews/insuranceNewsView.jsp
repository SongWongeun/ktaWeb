...
<meta property="og:title" content="화물공제조합 - 보험소식"/>
...
/* 글 수정 화면 function */
function updateInsuranceBoard(no) {
	document.boardForm.articleNo.value=no;
   	document.boardForm.action = "<c:url value='/kwa/infoLounge/insuranceNewsUpdate.do'/>";
...
/* 글 삭제 화면 function */
function deleteInsuranceBoard(no) {
	document.boardForm.articleNo.value = no;
   	document.boardForm.action = "<c:url value='/infoLounge/insuranceNewsDelete.do'/>";
   	document.boardForm.submit();		
}
		...
		<div id="container">
			<div class="contents" id="Contents">
				...
				<div class="conaArea insuBg">
					<div class="infoContit01"><p class="hide">보다 정확하고 발빠르게 전해드리는 화물공제조합 보험 소식입니다.</p></div>
					<!-- table view font&sns -->
					...
					<div class="conSection">
						...
						<div class="bbsView1">
							...
							<table class="tbIn_st01" summary="게시물의 첨부파일을 나타낸 테이블입니다.">
								<tr class="last">
							...
							<div class="btnboxR clfix">
								<span class="btn_pack btn_type01 icon"><span class="check"></span><a href="#;" onclick="listInsuranceBoard()">목록</a></span>
								<%-- <span class="btn_pack btn_type02"><a href="#;" onclick="updateInsuranceBoard('<c:out value="${resultBoard.articleNo}"/>')">수정</a></span>
								<span class="btn_pack btn_type02"><a href="#;" onclick="deleteInsuranceBoard('<c:out value="${resultBoard.articleNo}"/>')">삭제</a></span> --%>
							</div>
						</div>
						</fieldset>						
						</form:form>
...
<%-- <form:form commandName="insuranceBoardVO" name="boardForm" method="post">
...
<br>
<br>
<a href="javascript:listInsuranceBoard()">목록으로</a><br>
<a href="javascript:updateInsuranceBoard('<c:out value="${resultBoard.articleNo}"/>')">수정하기</a><br>
<a href="javascript:deleteInsuranceBoard('<c:out value="${resultBoard.articleNo}"/>')">삭제하기</a><br>
