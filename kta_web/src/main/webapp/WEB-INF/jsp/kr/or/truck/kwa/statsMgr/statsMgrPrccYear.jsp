...
$(document).ready(function(){
	...
	$('#sts_year .year').each(function(){
		$(this).on('click',function(){
			...
			var y = $(this).attr('y');
			location.href = '/kwa/statsMgr/prcc/year.do?year='+y;
		});
	});
	...
	$('#sts_month .year').each(function(){
		$(this).on('click',function(){
			...
			var y = $(this).attr('y');
			location.href = '/kwa/statsMgr/prcc/month.do?year='+y;
		});
	});
	/* end:월별통계 버튼설정 */
	/* start:일별통계 버튼설정 */
	...
	$('#sts_day .month').each(function(){
		$(this).on('click',function(){
			...
			var m = $(this).attr('m');
			location.href = '/kwa/statsMgr/prcc/day.do?year='+y+'&month='+m;
		});
	});
	...
	<div class="col-md-6 padded"> 
		<div class="box" >
			...
			<div class="box-content padded">
				<%-- <div class="sine-chart" style="height: 300px;width:<%=graphWidth%>px;" id="xchart-statistics1"></div> --%>
	...
	<div class="col-md-6 padded">
		<div class="box">
			...
			<div class="box-content padded">
				<%-- <div class="sine-chart" style="height: 300px;width:<%=graphWidth%>px;" id="xchart-statistics2"></div> --%>
			...
			var options1 = {
			    ...
			    func: {
			        tip: function(tipElement, data, rect) {
			            var date = data.xaxis;
			            var tip = '<div class="text">' + date + ': ' + String(data.yaxis)+'건 </div>';
