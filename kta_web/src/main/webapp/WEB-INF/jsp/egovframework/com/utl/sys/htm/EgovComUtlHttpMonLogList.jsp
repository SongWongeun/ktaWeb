...
<c:set var="ImgUrl" value="/images/egovframework/com/utl/sys/htm/"/>
<c:set var="CssUrl" value="/css/egovframework/com/utl/sys/htm/"/>
		  					...
		  					<td width="10%">
								<table border="0" cellspacing="0" cellpadding="0">
								    <tr>
		      							...
		      							<td>&nbsp;</td>
			      						<td><img src="${ImgUrl}button/bu2_left.gif" alt="조회버튼" title="조회버튼" width="8" height="20"></td>
			      						...
			      						<td><img src="<c:out value="${ImgUrl}"/>button/bu2_right.gif" alt="조회버튼" title="조회버튼" width="8" height="20"></td>
								    </tr>
		   						</table>
		  					</td>
		 				</tr>
