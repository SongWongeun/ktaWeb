...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
	<td><br><b>API TEST추가</b></td>
	</tr>
		<tr height = "16">
			<td align="left" valign="center" width="100%">
				<a href="/jsb/api/weather/weatherIndex.do" target="_content" class="link">현재날씨</a>
			</td>
		</tr>
		<tr>
			<td align="left" valign="center" width="100%">
				<a href="/jsb/api/addr/addrIndex.do" target="_content" class="link">주소검색</a>
			</td>
		</tr>
		<tr>
			<td align="left" valign="center" width="100%">
				<a href="/jsb/api/map/mapIndex.do" target="_content" class="link">찾아오시는 길</a>
			</td>
		</tr>
		<tr>
			<td><br><b>크로스에디터 테스트</b></td>
		</tr>
		<tr height = "16">
			<td align="left" valign="center" width="100%">
				<a href="/gsh/namo/namoIndex.do" target="_content" class="link">샘플페이지</a>
			</td>
		</tr>
				<tr>
			<td><br><b>1:1문의 게시판</b></td>
		</tr>
		<tr height = "16">
			<td align="left" valign="center" width="100%">
				<a href="/customer/inquiry/oaoInquiryIndex.do" target="_content" class="link">1:1문의</a>
			</td>
		</tr>
