...
<%
	...
	if( request.getHeader("host").startsWith("210.92.214.216") 
			|| request.getHeader("host").startsWith("192.1.60.16") 
			|| request.getHeader("host").indexOf( "truck.or.kr") >-1  ){//실서버
		
		imagePhysicalPath = "/jeus/data/homepage/namo_image_upload";
	}
%>
