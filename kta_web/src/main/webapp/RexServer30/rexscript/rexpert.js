...
var rex_gsPluginParam = {"datapath": rex_gsRexServiceRootURL + "/plugin/markany/MaFpsCommon.jsp",
					"datafilename": "MaPrintInfo_TRUCK.dat",
					"enablecapture": "0",
					"enablespool": "0",
					"enableprinter": "0",
					"printeroption": "3",
...
function rex_getRexCtl() {
	...
	if (  (oAgent.isWin || oAgent.isIE) ) {
		...
		if (oAgent.isIE || oAgent.isFF) {
			...
			//viewer 181 version more
			sCtl += "<script language='vbscript' for='RexCtl' event='ButtonPrintClickBefore(Cancel)'>";
			sCtl += "	Cancel = false" + "\r\n";
			sCtl += "	Call OnButtonPrintClickBefore(Cancel)" + "\r\n";
			sCtl += "</script>";
			
			sCtl += "<script type='text/javascript' for='RexCtl' event='ButtonPrintClickAfter'>" + "\r\n";
			sCtl += "	OnButtonPrintClickAfter();" + "\r\n";
			sCtl += "</script>" + "\r\n";	
			
			sCtl += "<script language='vbscript' for='RexCtl' event='ButtonExportClickBefore(Cancel)'>";
			sCtl += "	Cancel = false" + "\r\n";
			sCtl += "	Call OnButtonExportClickBefore(Cancel)" + "\r\n";
			sCtl += "</script>";
			
			sCtl += "<script type='text/javascript' for='RexCtl' event='ButtonExportClickAfter'>" + "\r\n";
			sCtl += "	OnButtonExportClickAfter();" + "\r\n";
			sCtl += "</script>" + "\r\n";	
			
			sCtl += "<script language='vbscript' for='RexCtl' event='ButtonRefreshClickBefore(Cancel)'>";
			sCtl += "	Cancel = false" + "\r\n";
			sCtl += "	Call OnButtonRefreshClickBefore(Cancel)" + "\r\n";
			sCtl += "</script>";
			
			sCtl += "<script type='text/javascript' for='RexCtl' event='ButtonRefreshClickAfter'>" + "\r\n";
			sCtl += "	OnButtonRefreshClickAfter();" + "\r\n";
			sCtl += "</script>" + "\r\n";	
			
			sCtl += "<script language='vbscript' for='RexCtl' event='ButtonExportXLSClickBefore(Cancel)'>";
			sCtl += "	Cancel = false" + "\r\n";
			sCtl += "	Call OnButtonExportXLSClickBefore(Cancel)" + "\r\n";
			sCtl += "</script>";
			
			sCtl += "<script type='text/javascript' for='RexCtl' event='ButtonExportXLSClickAfter'>" + "\r\n";
			sCtl += "	OnButtonExportXLSClickAfter();" + "\r\n";
			sCtl += "</script>" + "\r\n";	
			
			sCtl += "<script language='vbscript' for='RexCtl' event='ButtonExportPDFClickBefore(Cancel)'>";
			sCtl += "	Cancel = false" + "\r\n";
			sCtl += "	Call OnButtonExportPDFClickBefore(Cancel)" + "\r\n";
			sCtl += "</script>";
			
			sCtl += "<script type='text/javascript' for='RexCtl' event='ButtonExportPDFClickAfter'>" + "\r\n";
			sCtl += "	OnButtonExportPDFClickAfter();" + "\r\n";
			sCtl += "</script>" + "\r\n";	
			
			sCtl += "<script language='vbscript' for='RexCtl' event='ButtonExportHWPClickBefore(Cancel)'>";
			sCtl += "	Cancel = false" + "\r\n";
			sCtl += "	Call OnButtonExportHWPClickBefore(Cancel)" + "\r\n";
			sCtl += "</script>";
			
			sCtl += "<script type='text/javascript' for='RexCtl' event='ButtonExportHWPClickAfter'>" + "\r\n";
			sCtl += "	OnButtonExportHWPClickAfter();" + "\r\n";
			sCtl += "</script>" + "\r\n";	
			
			//check
			sCtl += "<script language='vbscript' for='RexCtl' event='CancelPrint(Cancel)'>";
			sCtl += "	Cancel = false" + "\r\n";
			sCtl += "	Call OnCancelPrint(Cancel)" + "\r\n";
			sCtl += "</script>";
		
			
			//check
			sCtl += "<script language='vbscript' for='RexCtl' event='ButtonCloseWindowClickBefore(Cancel)'>";
			sCtl += "	Cancel = false" + "\r\n";
			sCtl += "	Call OnButtonCloseWindowClickBefore(Cancel)" + "\r\n";
			sCtl += "</script>";	
			
			//check
			sCtl += "<script type='text/javascript' for='RexCtl' event='ButtonCloseWindowClickAfter'>" + "\r\n";
			sCtl += "	OnButtonCloseWindowClickAfter();" + "\r\n";
			sCtl += "</script>" + "\r\n";	
			
			// 
			sCtl += "<script type='text/javascript' for='RexCtl' event='PrintPage(totalpage, page)'>" + "\r\n";
			sCtl += "	OnPrintPage(totalpage, page);" + "\r\n";
			sCtl += "</script>" + "\r\n";	
			
			// check
			sCtl += "<script type='text/javascript' for='RexCtl' event='RexpertError(name, description)'>" + "\r\n";
			sCtl += "	OnRexpertError(name, description);" + "\r\n";
			sCtl += "</script>" + "\r\n";	
			
			sCtl += "<script type='text/javascript' for='RexCtl' event='CancelExport'>" + "\r\n";
			sCtl += "	OnCancelExport();" + "\r\n";
			sCtl += "</script>" + "\r\n";
			
			// check
			sCtl += "<script type='text/javascript' for='RexCtl' event='FinishPrintResult(resultcode)'>" + "\r\n";
			sCtl += "	OnFinishPrintResult(resultcode);" + "\r\n";
			sCtl += "</script>" + "\r\n";				
			...
			*/
			...
			if (isExistPath == false) {
				if (rex_gsServerVersion == "2.5") {
					...
					//add log
					sHttpParams += "<http-param name='REBNM'>" + rptname + "</http-param>";
...
rex_ParamSet.prototype.open = function(oWindow) {
	this.opentype = "open";
	
	//var oAgent = new rex_Agent();
	
	//if (oAgent.isWin) {
	if(oWindow == null || oWindow == "") {
		this.win = window.open(rex_gsPreViewURL + "?id=" + this.id, "", rex_gsPreViewFeatures);
	} else {
		this.win = window.open(rex_gsPreViewURL + "?id=" + this.id, oWindow, rex_gsPreViewFeatures);
	}	
	//} else {
	// Mac, Unix(Linux)
