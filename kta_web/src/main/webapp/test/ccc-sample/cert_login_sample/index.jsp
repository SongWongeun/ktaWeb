                  ...
                  <td align="center">
                    ...
                    <table width="80%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="93%" height="20"><font size="2" color="#333333">사용자가 
                                최초 접속하는 경우 컴퓨터 및 네트웍의 </font></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td width="7%" align="center">&nbsp;</td>
                        <td width="93%" height="20"><font size="2" color="#333333">반드시</font><font size="2"> <font color="#FF6633"><b>&quot;</b></font></font><b><font color="#FF6633" size="2">예&quot;</font></b><font color="#333333" size="2">를 클릭하십시요.</font><font color="#FF6633" size="2"> 
                                <b>&nbsp;&quot;아니오&quot;</b></font><font color="#333333" size="2">를 
                                클릭하시는 경우는 </font></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td width="7%" align="center"><img src="./CCimages/cs_dot01.gif" width="11" height="11" border="0"></td>
                        <td width="93%" height="20"><font color="#FF6633" size="2">화면이 장시간 정지 시에는 프로그램을 
                                수동설치하셔야 합니다.</font></td>
                      </tr>
...
<object id="CC_Object_id"
	  ...
	  codebase="AxCrossCert.cab#Version=2,6,4,0"
...
if (CC_Object_id.object == null) {
	location="./manual_install.jsp" //수동설치
	} else {
	location="menu.jsp" //완료메시지 
}
-->
</SCRIPT>
</body>
