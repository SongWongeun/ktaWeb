...
function SignData()
{
	...
	{
		alert("주민/사업자 번호 입력 요망");
		document.frm.idn.focus();
		return;
	}
	...
	else
	{
		...
		else
		{
			...
			document.frm.action = "cert_reg_check.jsp";
...
<input type = button value = "인증서 등록" OnClick = "SignData()">
...
<table>
  ...
  <tr> 
   ...
   <tr> 
	<td align="center"> ID  (입력)
	</td>
	<td align="center"><input type = "text" name = "userid">
	</td>
   </tr>
   <tr>
	<td align="center"> PWD  (입력)
	</td>
	<td align="center"><input type = "text" name = "userpwd"> 
	</td>
   </tr>
   <tr> 
