...
<%  
	...
	String src = new String(request.getParameter("src").getBytes("iso-8859-1"), "EUC-KR");		        // 원문	
	...
	*/
	...
	String Policies = "1.2.410.200004.5.2.1.1|1.2.410.200004.5.1.1.7|1.2.410.200005.1.1.5|1.2.410.200004.5.3.1.1|1.2.410.200004.5.3.1.2|1.2.410.200004.5.4.1.2|1.2.410.200012.1.1.3";
